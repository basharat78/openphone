        ...
        <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
            ...
            <div class="relative z-10 w-full max-w-md px-6">
                ...
                <div class="text-center mb-8">
                    <div class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-600 shadow-2xl shadow-purple-500/50 mb-4">
                        <span class="text-2xl font-black text-white">OP</span>
                    </div>
                    <h1 class="text-3xl font-bold text-white mb-2">OpenPhone</h1>
                    <p class="text-gray-400 text-sm">QC Integration Platform</p>
                </div>

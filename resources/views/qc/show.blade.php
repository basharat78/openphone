                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="bg-[#1f2937]/90 backdrop-blur-sm rounded-3xl shadow-2xl shadow-black/50 border border-gray-800 p-8">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-8">
                            ...
                            <div class="flex items-start">
                                <div class="p-3 bg-cyan-500/10 text-cyan-400 rounded-xl mr-4 border border-cyan-500/20">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg>
                                </div>
                                <div>
                                    <dt class="text-xs font-bold text-gray-500 uppercase tracking-widest">Client Number</dt>
                                    <dd class="text-sm font-bold text-gray-100 mt-1">{{ $call->direction === 'outgoing' ? $call->to_number : $call->from_number }}</dd>
                                </div>
                            </div>
                            <div class="flex items-start">
